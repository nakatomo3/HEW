...
void SelectCharacter::Load() {//”wŒi@ã‚ªƒvƒŒƒCƒ„[”wŒi(1–‡)@‰º‚ªƒLƒƒƒ‰”wŒi(4–‡)
	...
	selectCharacterSprite1->SetPosition(new Vector3(SCREEN_WIDTH *0.2f, SCREEN_HEIGHT / 1.4f + SD_HEIGHT * 0.5, -0.01f));// ”wŒi‚ÌˆÊ’u
	...
	selectCharacterSprite2->SetPosition(new Vector3(SCREEN_WIDTH *0.4f, SCREEN_HEIGHT / 1.4f + SD_HEIGHT * 0.5, -0.01f));// ”wŒi‚ÌˆÊ’u
	...
	selectCharacterSprite3->SetPosition(new Vector3(SCREEN_WIDTH *0.6f, SCREEN_HEIGHT / 1.4f + SD_HEIGHT * 0.5, -0.01f));// ”wŒi‚ÌˆÊ’u
	...
	selectCharacterSprite4->SetPosition(new Vector3(SCREEN_WIDTH *0.8f, SCREEN_HEIGHT / 1.4f + SD_HEIGHT * 0.5, -0.01f));// ”wŒi‚ÌˆÊ’u
	...
	if (playerCount >= 2) {// ƒvƒŒƒCƒ„[‚ª2l‚Ì
		if (isReady[1] == false) {
			...
			if (Input::GetInstance().GetController(1).Gamepad.sThumbLX > 5000) {
				if (wasInput[1] == false) {
					if (cursorPositions[1] <= 2) {// 2ˆÈã‚É‚µ‚È‚¢
						cursorPositions[1]++;
					}
				}
				wasInput[1] = true;
				...
				if (wasInput[1] == false) {
					if (cursorPositions[1] >= 1) {// 1ˆÈ‰º‚É‚µ‚È‚¢
						cursorPositions[1]--;
					}
				}
				wasInput[1] = true;
	...
	if (playerCount >= 3) {// ƒvƒŒƒCƒ„[‚ª3l‚Ì
		if (isReady[2] == false) {
			...
			if (Input::GetInstance().GetController(2).Gamepad.sThumbLX > 5000) {
				if (wasInput[2] == false) {
					if (cursorPositions[2] <= 2) {// 2ˆÈã‚É‚µ‚È‚¢
						cursorPositions[2]++;
					}
				}
				wasInput[2] = true;
				...
				if (wasInput[2] == false) {
					if (cursorPositions[2] >= 1) {// 1ˆÈ‰º‚É‚µ‚È‚¢
						cursorPositions[2]--;
					}
				}
				wasInput[2] = true;
	...
	if (playerCount >= 4) {// ƒvƒŒƒCƒ„[‚ª4l‚Ì
		if (isReady[3] == false) {
			...
			if (Input::GetInstance().GetController(3).Gamepad.sThumbLX > 5000) {
				if (wasInput[3] == false) {
					if (cursorPositions[3] <= 2) {// 2ˆÈã‚É‚µ‚È‚¢
						cursorPositions[3]++;
					}
				}
				wasInput[3] = true;
				...
				if (wasInput[3] == false) {
					if (cursorPositions[3] >= 1) {// 1ˆÈ‰º‚É‚µ‚È‚¢
						cursorPositions[3]--;
					}
				}
				wasInput[3] = true;
