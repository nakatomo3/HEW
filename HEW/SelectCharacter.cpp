...
void SelectCharacter::Load() {//îwåiÅ@è„Ç™ÉvÉåÉCÉÑÅ[îwåi(1ñá)Å@â∫Ç™ÉLÉÉÉâîwåi(4ñá)
	...
	backgroundSprite->SetPosition(new Vector3(SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2, 0));// îwåiÇÃà íu
	backgroundSprite->SetColor(new Color(0, 0, 0, 0));// çïêFîwåi
	...
	playerBackgroundSprite->SetPosition(new Vector3(SCREEN_WIDTH/2, SCREEN_HEIGHT /3.55, 0));// îwåiÇÃà íu
	playerBackgroundSprite->SetColor(new Color(255, 255, 255, 0));// îíêFîwåi
	...
	selectCharacterSprite1->SetPosition(new Vector3(SCREEN_WIDTH *0.2, SCREEN_HEIGHT / 1.4, 0));// îwåiÇÃà íu
	selectCharacterSprite1->SetColor(new Color(255, 255, 255, 0));// îíêFîwåi
	...
	selectCharacterSprite2->SetPosition(new Vector3(SCREEN_WIDTH *0.4, SCREEN_HEIGHT / 1.4, 0));// îwåiÇÃà íu
	selectCharacterSprite2->SetColor(new Color(255, 255, 0, 0));// ê‘êFîwåi
	...
	selectCharacterSprite3->SetPosition(new Vector3(SCREEN_WIDTH *0.6, SCREEN_HEIGHT / 1.4, 0));// îwåiÇÃà íu
	selectCharacterSprite3->SetColor(new Color(255, 255, 255, 0));// îíêFîwåi
	...
	selectCharacterSprite4->SetPosition(new Vector3(SCREEN_WIDTH *0.8, SCREEN_HEIGHT / 1.4, 0));// îwåiÇÃà íu
	selectCharacterSprite4->SetColor(new Color(255, 255, 0, 0));// ê‘êFîwåi
}
